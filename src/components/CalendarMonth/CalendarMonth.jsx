   ...
   return (<>
      ...
      <div className={stl.wrapp}>{
         arrDays.map((numDay, i) => {
            ...
            const eventsOfDay = () => {
               if (eventDataForMonth &&
                  ...
                  return eventDataForMonth
                     ...
                     .map((elem, i) => <li key={elem.date + i}
                        onClick={() => {
                           isModalSet(true,
                              <UpdateEventConteiner idEvent={elem._id}
                                 tit={elem.title} desc={elem.desc} dte={elem.date} />
                           )
                        }}
                     > {elem.title}</li>)
               }
            ...
            return (
               <div key={numDay.format(`DDMMYYYY${i}`)} className={classWeek()}
                  onDoubleClick={() => {
                     isAuth ?
                        isModalSet(true,
