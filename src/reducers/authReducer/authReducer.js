...
export const password_reset_Auth = (payload) => ({
	type: password_reset_Type,
	payload,
});
export const password_reset_link_Auth = (payload) => ({
	type: password_reset_link_Type,
	payload,
});
...
export const modalChildren_Auth = (payload) => ({
	type: modalChildren_Type,
	payload,
});
